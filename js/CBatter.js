function CBatter(oParentContainer, iTeam) {
    ...
    this._init = function (oParentContainer, iTeam) {
        ...
        for (var i = 0; i < NUM_SPRITE_BATTING; i++) {
            _aBatter_batter.push(createBitmap(s_oSpriteLibrary.getSprite("batter_batting_" + iTeam + "_" + i)));
            _aBatter_batter[i].x = BATTER_X;
            _aBatter_batter[i].y = BATTER_Y;
        ...
        for (var i = 0; i < NUM_SPRITE_PLAYERS; i++) {
            _aBatter_idle.push(createBitmap(s_oSpriteLibrary.getSprite("batter_idle_" + iTeam + "_" + i)));
