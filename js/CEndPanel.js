function CEndPanel(oSpriteBg) {
	...
	this.show = function (iScore) {
		...
		if (LEVEL == 0 && iScore >= 8)
			_oMsgText1.text =
				TEXT_PANEL + iScore + TEXT_PANEL_POINT + TEXT_REDEEM + '8 Runs'
		else if (LEVEL == 1 && iScore >= 10)
			_oMsgText1.text =
				TEXT_PANEL + iScore + TEXT_PANEL_POINT + TEXT_REDEEM + '10 Runs'
		else if (LEVEL == 2 && iScore >= 12)
			_oMsgText1.text =
				TEXT_PANEL + iScore + TEXT_PANEL_POINT + TEXT_REDEEM + '12 Runs'
		else _oMsgText1.text = TEXT_GAMEOVER
